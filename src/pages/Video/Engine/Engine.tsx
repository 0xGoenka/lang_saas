...
export const Engine = ({ cardRecord, f, className }) => {
  return (
...
export const ScheduledButton = ({ rating, children, handleClick, tip }) => {
  return (
    <button
...
export const ExampleGenerator = ({
  ...
  const handleClick = (e, rating) => {
    ...
    setCards((pre) => [scheduling_cards[rating].card]);
    setLogs((pre) => [scheduling_cards[rating].log]);
  };
  return (
    <div>
      <ScheduledButton
